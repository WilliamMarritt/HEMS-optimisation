...
def run_single_simulation(params):
    ...
    for step in range(48): 
        ...
        if step_smart_import > I_max:
            smart_breach_count += 1
            # "Area" above the limit (kW * hours)
            smart_breach_energy += (step_smart_import - I_max) * delta
            
        if step_open_import > I_max:
            open_breach_count += 1
            open_breach_energy += (step_open_import - I_max) * delta
...
if __name__ == '__main__':
    ...
    axes[0, 1].set_title('Transformer Limit: Breach Frequency Prevention', fontsize=14, fontweight='bold')
    ...
    axes[0, 2].set_title('Transformer Limit: Breach Severity Prevention', fontsize=14, fontweight='bold')
